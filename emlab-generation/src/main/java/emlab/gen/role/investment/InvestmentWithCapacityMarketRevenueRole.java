...
@Configurable
@NodeEntity
public class InvestmentWithCapacityMarketRevenueRole<T extends EnergyProducer> extends GenericInvestmentRole<T>
implements
Role<T>,
NodeBacked {
        ...
        for (PowerGeneratingTechnology technology : reps.genericRepository.findAll(PowerGeneratingTechnology.class)) {
            ...
            if ((expectedInstalledCapacityOfTechnology + plant.getActualNominalCapacity())
                ...
                if (runningHours < plant.getTechnology().getMinimumRunningHours()) {
                    ...
                    operatingProfit = operatingRevenueWithoutCapacityMarketRevenue + capacityRevenue;
